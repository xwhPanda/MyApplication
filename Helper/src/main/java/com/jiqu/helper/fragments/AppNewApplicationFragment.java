 ...
 */
public class AppNewApplicationFragment extends BaseFragment implements RecycleViewOnItemClickListener{
    private final String OKHTTP_TAG = "AppNewApplicationFragment";
    ...
    public View getContentView() {
        View view = LayoutInflater.from(mActivity).inflate(R.layout.app_new_application_layout,null);
        return view;
    }
    ...
    public void initData() {
        OkHttpManager.getInstance().execute(new OkHttpRequest(RequestTools.APP_NEW_APPLICATION, OKHTTP_TAG, null, null).build(), AppRankingData.class, new GetDataCallback() {
            @Override
