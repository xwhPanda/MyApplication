...
public class ClearTool {
	...
	private Map<String, GetAppSizeRunnable> tasks = new ConcurrentHashMap<String, GetAppSizeRunnable>();
...
//								externalCacheSize += pStats.externalCacheSize + pStats.externalMediaSize;
								...
								++count;
								if (HelperApplication.PACKAGE_NAME.equals(packageName)) {
									cachesize = pStats.cacheSize;
									deleteFolderFile(HelperApplication.DATA_CACHE_PATH, false);
								}
								if (count == size) {
	...
	public List<RunningAppProcessInfo> getProcess(Context context,Handler handler){
        ...
        List<RunningAppProcessInfo> processInfos = new ArrayList<RunningAppProcessInfo>();
...
//                    String[] pkgList = appProcessInfo.pkgList;
	...
	public void killProcess(List<RunningAppProcessInfo> processInfos,Handler handler){
		ActivityManager am = (ActivityManager) HelperApplication.context.getSystemService(Context.ACTIVITY_SERVICE);
//        List<RunningAppProcessInfo> infoList = am.getRunningAppProcesses();
